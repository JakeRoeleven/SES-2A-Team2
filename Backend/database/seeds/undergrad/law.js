...
async function BachelorOfLaw(num_of_students) {
    ...
    const Interests = ['Law', 'History','Language', 'Art', 'Humanities', 'Business', 'Economics']
    const Core = ['https://handbook.uts.edu.au/directory/stm90832.html']
    const Electives = ['https://handbook.uts.edu.au/directory/stm90792.html', 'https://handbook.uts.edu.au/directory/cbk90922.html', 'https://handbook.uts.edu.au/directory/maj09443.html', 'https://handbook.uts.edu.au/directory/cbk90923.html']
    ...
    for (let i = 0; i < (num_of_students); i++) {   
        ...
        if (year === 0) year = 1;
        studentService.setStudent(uniqid(), await buildStudents(year, 'Bachelor of Law', Interests, Core, Electives))
    }
