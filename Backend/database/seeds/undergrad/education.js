...
async function BachelorOfArtsEducationalStudies(num_of_students) {
    ...
    const Interests = ['Education', 'Health', 'History','Language', 'Art', 'Humanities', 'Writing', 'Communications', 'Music', 'Geography']
    const Core = ['https://handbook.uts.edu.au/directory/stm91503.html', 'https://handbook.uts.edu.au/directory/stm91211.html', 'https://handbook.uts.edu.au/directory/stm91207.html']
    const Electives = ['https://handbook.uts.edu.au/directory/cbk91938.html', 'https://handbook.uts.edu.au/directory/cbk91119.html', 'https://handbook.uts.edu.au/directory/maj07100.html']
    ...
    for (let i = 0; i < (num_of_students); i++) {   
        ...
        if (year === 0) year = 1;
        studentService.setStudent(uniqid(), await buildStudents(year, 'Bachelor of Arts in Educational Studies', Interests, Core, Electives))
    }
...
BachelorOfArtsEducationalStudies(500)
