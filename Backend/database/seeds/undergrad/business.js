...
async function BachelorOfBusiness(num_of_students) {
    ...
    const Interests = ['History','Language', 'Art', 'Humanities', 'Business', 'Economics', 'Language', 'Marketing']
    const Core = ['https://handbook.uts.edu.au/directory/stm90273.html']
    const Electives = ['https://handbook.uts.edu.au/directory/maj08981.html', 'https://handbook.uts.edu.au/directory/maj08437.html', 
    'https://handbook.uts.edu.au/directory/maj09209.html', 'https://handbook.uts.edu.au/directory/maj08440.html', 'https://handbook.uts.edu.au/directory/maj08446.html', 
    'https://handbook.uts.edu.au/directory/maj08442.html', 'https://handbook.uts.edu.au/directory/maj08438.html' , 'https://handbook.uts.edu.au/directory/maj08441.html']
    ...
    for (let i = 0; i < (num_of_students); i++) {   
        ...
        if (year === 0) year = 1;
        studentService.setStudent(uniqid(), await buildStudents(year, 'Bachelor of Business', Interests, Core, Electives))
    }
    // console.timeEnd("loop")

}

async function BachelorOfAccounting(num_of_students) {

    // const all_interests = ['Programming', 'Maths', 'Statistics', 'Hospitality', 'Fitness', 'Language', 'Art', 'Humanities',
    // 'Architecture', 'History', 'Geography', 'Business', 'Economics', 'Education', 'Health', 'Engineering', 'Law', 'Computing',
    // 'Physics', 'Chemistry', 'Biology', 'Electronics', 'Medicine', 'Data Analytics', 'Mechanics', 'Games', 'Marketing', 'Accounting']

    const Interests = ['History','Language', 'Art', 'Humanities', 'Business', 'Economics', 'Language', 'Marketing']
    const Core = ['https://handbook.uts.edu.au/directory/maj08437.html', 'https://handbook.uts.edu.au/courses/c10235.html']
    const Electives = ['https://handbook.uts.edu.au/directory/maj08981.html', 'https://handbook.uts.edu.au/directory/smj01009.html', 
    'https://handbook.uts.edu.au/directory/smj08123.html', 'https://handbook.uts.edu.au/directory/smj09058.html' , 'https://handbook.uts.edu.au/directory/smj08137.html']
    ...
    for (let i = 0; i < (num_of_students); i++) {   
        ...
        let year = Math.floor(Math.random() * 5) 
        if (year === 0) year = 1;
        studentService.setStudent(uniqid(), await buildStudents(year, 'Bachelor of Accounting', Interests, Core, Electives))
    }
    // console.timeEnd("loop")

}

async function BachelorOfManagement(num_of_students) {

    // const all_interests = ['Programming', 'Maths', 'Statistics', 'Hospitality', 'Fitness', 'Language', 'Art', 'Humanities',
    // 'Architecture', 'History', 'Geography', 'Business', 'Economics', 'Education', 'Health', 'Engineering', 'Law', 'Computing',
    // 'Physics', 'Chemistry', 'Biology', 'Electronics', 'Medicine', 'Data Analytics', 'Mechanics', 'Games', 'Marketing', 'Accounting']

    const Interests = ['Language', 'Art', 'Humanities', 'Business', 'Economics', 'Marketing', 'Geography']
    const Core = ['https://handbook.uts.edu.au/directory/stm90928.html', 'https://handbook.uts.edu.au/directory/stm90929.html']
    const Electives = ['https://handbook.uts.edu.au/directory/maj08977.html', 'https://handbook.uts.edu.au/directory/stm90928.html', 
    'https://handbook.uts.edu.au/directory/maj08980.html', 'https://handbook.uts.edu.au/directory/maj08975.html']
    ...
    for (let i = 0; i < (num_of_students); i++) {   
        ...
        let year = Math.floor(Math.random() * 5) 
        if (year === 0) year = 1;
        studentService.setStudent(uniqid(), await buildStudents(year, 'Bachelor of Management', Interests, Core, Electives))
    }
    // console.timeEnd("loop")

}

async function BachelorOfEconomics(num_of_students) {
    ...
    const Interests = ['Language', 'Art', 'Humanities', 'Business', 'Economics', 'Marketing', 'Geography']
    const Core = ['https://handbook.uts.edu.au/directory/stm91017.html']
    const Electives = ['https://handbook.uts.edu.au/directory/cbk91076.html']
...
BachelorOfBusiness(500);
BachelorOfAccounting(400);
BachelorOfManagement(300);
BachelorOfEconomics(300)
