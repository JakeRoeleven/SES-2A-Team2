 ...
 */
declare type GridRowModel = GridObjectWithId & GridRowData;
...
declare const GridFilterToolbarButton: React$1.FC<{}>;
...
declare const GRID_COLUMN_REORDER_START = "columnReordering:dragStart";
declare const GRID_COLUMN_REORDER_DRAG_OVER_HEADER = "columnReordering:dragOverHeader";
declare const GRID_COLUMN_REORDER_DRAG_OVER = "columnReordering:dragOver";
declare const GRID_COLUMN_REORDER_DRAG_ENTER = "columnReordering:dragEnter";
declare const GRID_COLUMN_REORDER_DRAG_END = "columnReordering:dragEnd";
...
declare const visibleSortedGridRowsSelector: reselect.OutputSelector<GridState, GridRowModel[], (res1: VisibleGridRowsState, res2: GridRowModel[]) => GridRowModel[]>;
...
declare const unorderedGridRowModelsSelector: reselect.OutputSelector<GridState, GridRowModel[], (res: InternalGridRowsState) => GridRowModel[]>;
...
declare const sortedGridRowsSelector: reselect.OutputSelector<GridState, GridRowModel[], (res1: GridRowId[], res2: GridRowsLookup, res3: GridRowModel[]) => GridRowModel[]>;
...
declare const isAlphaKeys: (key: string) => boolean;
